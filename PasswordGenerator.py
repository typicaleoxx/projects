...
def main():
    user_length = int(
        input("How many characters would you like your generated password to have?")
    )
    ...
    print(
        f"Your generated password is: {generate_password(user_length,user_upper,user_lower,user_numbers,user_symbols)}"
    )
